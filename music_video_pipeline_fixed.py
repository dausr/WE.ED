...
# -*- coding: utf-8 -*-
"""
1-Click-1-File Musikvideo-Pipeline (Fixed Version)
Automatisches Matching von Songs und Clips basierend auf semantischen Eigenschaften.
Kompatibel mit Python 3.14 und ohne torchcodec/sentence-transformers.
"""
...
# --- 8. Haupt-Pipeline ---
def main():
    print("🚀 Starte Musikvideo-Pipeline (Fixed Version)...")
